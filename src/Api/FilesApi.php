...
class FilesApi
{
     ...
     * @param  string $filename Nome do arquivo (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filesShow'] to see the possible values for this operation
     *
    ...
    /**
     * Operation filesShowWithHttpInfo
     *
     * Faz o download de um arquivo
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     */
    public function filesShowAsync($promotion_id, $filename, string $contentType = self::contentTypes['filesShow'][0])
    {
        return $this->filesShowAsyncWithHttpInfo($promotion_id, $filename, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation filesShowAsyncWithHttpInfo
     *
     * Faz o download de um arquivo
     *
     * @param  string $promotion_id ID da promoção (required)
    ...
    /**
     * Create request for operation 'filesShow'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $filename Nome do arquivo (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filesShow'] to see the possible values for this operation
     ...
     */
    public function filesShowRequest($promotion_id, $filename, string $contentType = self::contentTypes['filesShow'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling filesShow'
            );
        }
        ...
        if ($filename === null || (is_array($filename) && count($filename) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $filename when calling filesShow'
            );
        }

...
/**
 * PromotionDataApi Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
...
class PromotionDataApi
{
    ...
    /**
     * Operation configsIndex
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['configsIndex'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotion\Model\ConfigsIndex200Response|\IdpluggerPromotion\Model\ConfigsIndex400Response|\IdpluggerPromotion\Model\ConfigsIndex401Response
     */
    public function configsIndex($promotion_id, string $contentType = self::contentTypes['configsIndex'][0])
    {
        list($response) = $this->configsIndexWithHttpInfo($promotion_id, $contentType);
        return $response;
    }

    /**
     * Operation configsIndexWithHttpInfo
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotion\Model\ConfigsIndex200Response|\IdpluggerPromotion\Model\ConfigsIndex400Response|\IdpluggerPromotion\Model\ConfigsIndex401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function configsIndexWithHttpInfo($promotion_id, string $contentType = self::contentTypes['configsIndex'][0])
    {
        $request = $this->configsIndexRequest($promotion_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\ConfigsIndex200Response',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function configsIndexAsync($promotion_id, string $contentType = self::contentTypes['configsIndex'][0])
    {
        return $this->configsIndexAsyncWithHttpInfo($promotion_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation configsIndexAsyncWithHttpInfo
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configsIndexAsyncWithHttpInfo($promotion_id, string $contentType = self::contentTypes['configsIndex'][0])
    {
        $returnType = '\IdpluggerPromotion\Model\ConfigsIndex200Response';
        $request = $this->configsIndexRequest($promotion_id, $contentType);
    ...
    /**
     * Create request for operation 'configsIndex'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['configsIndex'] to see the possible values for this operation
     *
     ...
     */
    public function configsIndexRequest($promotion_id, string $contentType = self::contentTypes['configsIndex'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling configsIndex'
            );
        }

...
class AwardsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsCreate'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotion\Model\AwardsCreate200Response|\IdpluggerPromotion\Model\AwardsCreate400Response|\IdpluggerPromotion\Model\AwardsCreate401Response
     */
    public function awardsCreate($promotion_id, $award = null, string $contentType = self::contentTypes['awardsCreate'][0])
    {
        list($response) = $this->awardsCreateWithHttpInfo($promotion_id, $award, $contentType);
        return $response;
    }

    /**
     * Operation awardsCreateWithHttpInfo
     *
     * Cadastra um prêmio na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotion\Model\AwardsCreate200Response|\IdpluggerPromotion\Model\AwardsCreate400Response|\IdpluggerPromotion\Model\AwardsCreate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function awardsCreateWithHttpInfo($promotion_id, $award = null, string $contentType = self::contentTypes['awardsCreate'][0])
    {
        $request = $this->awardsCreateRequest($promotion_id, $award, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsCreate200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsCreate400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsCreate401Response',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function awardsCreateAsync($promotion_id, $award = null, string $contentType = self::contentTypes['awardsCreate'][0])
    {
        return $this->awardsCreateAsyncWithHttpInfo($promotion_id, $award, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation awardsCreateAsyncWithHttpInfo
     *
     * Cadastra um prêmio na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function awardsCreateAsyncWithHttpInfo($promotion_id, $award = null, string $contentType = self::contentTypes['awardsCreate'][0])
    {
        $returnType = '\IdpluggerPromotion\Model\AwardsCreate200Response';
        $request = $this->awardsCreateRequest($promotion_id, $award, $contentType);
    ...
    /**
     * Create request for operation 'awardsCreate'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdpluggerPromotion\Model\Award[]|null $award (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsCreate'] to see the possible values for this operation
     ...
     */
    public function awardsCreateRequest($promotion_id, $award = null, string $contentType = self::contentTypes['awardsCreate'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling awardsCreate'
            );
        }
    ...
    /**
     * Operation awardsDelete
     *
     * Deleta um prêmio da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $id ID do prêmio (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsDelete'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotion\Model\AwardsDelete200Response|\IdpluggerPromotion\Model\AwardsDelete400Response|\IdpluggerPromotion\Model\AwardsDelete401Response
     */
    public function awardsDelete($promotion_id, $id, string $contentType = self::contentTypes['awardsDelete'][0])
    {
        list($response) = $this->awardsDeleteWithHttpInfo($promotion_id, $id, $contentType);
        return $response;
    }

    /**
     * Operation awardsDeleteWithHttpInfo
     *
     * Deleta um prêmio da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotion\Model\AwardsDelete200Response|\IdpluggerPromotion\Model\AwardsDelete400Response|\IdpluggerPromotion\Model\AwardsDelete401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function awardsDeleteWithHttpInfo($promotion_id, $id, string $contentType = self::contentTypes['awardsDelete'][0])
    {
        $request = $this->awardsDeleteRequest($promotion_id, $id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsDelete200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsDelete400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsDelete401Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function awardsDeleteAsync($promotion_id, $id, string $contentType = self::contentTypes['awardsDelete'][0])
    {
        return $this->awardsDeleteAsyncWithHttpInfo($promotion_id, $id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation awardsDeleteAsyncWithHttpInfo
     *
     * Deleta um prêmio da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function awardsDeleteAsyncWithHttpInfo($promotion_id, $id, string $contentType = self::contentTypes['awardsDelete'][0])
    {
        $returnType = '\IdpluggerPromotion\Model\AwardsDelete200Response';
        $request = $this->awardsDeleteRequest($promotion_id, $id, $contentType);
    ...
    /**
     * Create request for operation 'awardsDelete'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $id ID do prêmio (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function awardsDeleteRequest($promotion_id, $id, string $contentType = self::contentTypes['awardsDelete'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling awardsDelete'
            );
        }
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling awardsDelete'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsIndex'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation awardsIndexWithHttpInfo
     *
     * Pesquisa por prêmios na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
    ...
    public function awardsIndexWithHttpInfo($promotion_id, $_fields = null, $_include = null, $page = null, $_per_page = null, $id = null, $raffle_id = null, $raffle_type = null, string $contentType = self::contentTypes['awardsIndex'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsIndex200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsIndex400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsIndex401Response',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation awardsIndexAsyncWithHttpInfo
     *
     * Pesquisa por prêmios na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
    ...
    /**
     * Create request for operation 'awardsIndex'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string|null $_fields Campos a serem retornados (optional)
     * @param  string|null $_include Dados relacionados a serem retornados (optional)
    ...
    /**
     * Operation awardsUpdate
     *
     * Cadastra ou atualiza um prêmio na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdpluggerPromotion\Model\Award[]|null $award award (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsUpdate'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotion\Model\AwardsUpdate200Response|\IdpluggerPromotion\Model\AwardsUpdate400Response|\IdpluggerPromotion\Model\AwardsUpdate401Response
     */
    public function awardsUpdate($promotion_id, $award = null, string $contentType = self::contentTypes['awardsUpdate'][0])
    {
        list($response) = $this->awardsUpdateWithHttpInfo($promotion_id, $award, $contentType);
        return $response;
    }

    /**
     * Operation awardsUpdateWithHttpInfo
     *
     * Cadastra ou atualiza um prêmio na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotion\Model\AwardsUpdate200Response|\IdpluggerPromotion\Model\AwardsUpdate400Response|\IdpluggerPromotion\Model\AwardsUpdate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function awardsUpdateWithHttpInfo($promotion_id, $award = null, string $contentType = self::contentTypes['awardsUpdate'][0])
    {
        $request = $this->awardsUpdateRequest($promotion_id, $award, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsUpdate200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsUpdate400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\AwardsUpdate401Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function awardsUpdateAsync($promotion_id, $award = null, string $contentType = self::contentTypes['awardsUpdate'][0])
    {
        return $this->awardsUpdateAsyncWithHttpInfo($promotion_id, $award, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation awardsUpdateAsyncWithHttpInfo
     *
     * Cadastra ou atualiza um prêmio na promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function awardsUpdateAsyncWithHttpInfo($promotion_id, $award = null, string $contentType = self::contentTypes['awardsUpdate'][0])
    {
        $returnType = '\IdpluggerPromotion\Model\AwardsUpdate200Response';
        $request = $this->awardsUpdateRequest($promotion_id, $award, $contentType);
    ...
    /**
     * Create request for operation 'awardsUpdate'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdpluggerPromotion\Model\Award[]|null $award (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['awardsUpdate'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function awardsUpdateRequest($promotion_id, $award = null, string $contentType = self::contentTypes['awardsUpdate'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling awardsUpdate'
            );
        }

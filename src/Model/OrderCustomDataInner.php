...
/**
 * OrderCustomDataInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class OrderCustomDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_custom_data_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('group', $data ?? [], 'external');
    }
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key Chave ou identificador da metatag
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Valor da metatag
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Tipo da metatag (Não obrigatório)
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string|null $group Grupo da metatag (Não obrigatório)
     *
     * @return self
     */

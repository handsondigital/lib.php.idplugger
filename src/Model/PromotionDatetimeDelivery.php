...
/**
 * PromotionDatetimeDelivery Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionDatetimeDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotion_datetime_delivery';
    ...
    */
     ...
     * Sets start
     *
     * @param string|null $start Data e hora em que os prêmios da promoção começaram a ser enviados aos ganhadores
     *
     * @return self
     */

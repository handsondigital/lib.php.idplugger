...
/**
 * InstantAwardAttempts200ResponseContent Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class InstantAwardAttempts200ResponseContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'instant_award_attempts_200_response_content';
    ...
    */
     ...
     * Sets attempts
     *
     * @param int|null $attempts Quantidade de chances que o participante ainda tem disponível
     *
     * @return self
     */
     ...
     * Sets executed
     *
     * @param int|null $executed Quantidade de chances que o participante já utilizou
     *
     * @return self
     */

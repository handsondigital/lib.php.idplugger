...
/**
 * PromotionDatetimeActive Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionDatetimeActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotion_datetime_active';
    ...
    */
     ...
     * Sets start
     *
     * @param string|null $start Data e hora em que a promoção começará oficialmente
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end Data e hora em que a promoção será encerrada oficialmente
     *
     * @return self
     */

...
/**
 * BrandingMenuInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class BrandingMenuInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Branding_menu_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('target_blank', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title Texto do link/botão do menu
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url url do link/botão do menu
     *
     * @return self
     */
    ...
    {
        return $this->container['target_blank'];
    }

    /**
     * Sets target_blank
     *
     * @param string|null $target_blank on=Abrir url em nova aba do navegador, off=Abrir url na mesma aba do navegador
     *
     * @return self
     */
    public function setTargetBlank($target_blank)
    {
        if (is_null($target_blank)) {
            throw new \InvalidArgumentException('non-nullable target_blank cannot be null');
        }
        $this->container['target_blank'] = $target_blank;

...
/**
 * PromotionDatetimeParticipate Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionDatetimeParticipate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotion_datetime_participate';
    ...
    */
     ...
     * Sets start
     *
     * @param string|null $start Data e hora em que a promoção começará a aceitar cadastros oficialmente
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end Data e hora em que a promoção irá parar de aceitar cadastros oficialmente
     *
     * @return self
     */

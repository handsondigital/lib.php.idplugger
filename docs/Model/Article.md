...
------------ | ------------- | ------------- | -------------
**id** | **int** | Identificador único da publicação na promoção | [optional]
**author_id** | **int** | Identificador do usuário da promoção autor da publicação | [optional]
**title** | **string** | Título da publicação |
**guid** | **string** | Identificador global da publicação (será usado na url da publicação) | [optional]
**content** | **string** | Conteúdo da publicação | [optional]

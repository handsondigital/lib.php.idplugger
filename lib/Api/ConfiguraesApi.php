...
/**
 * ConfiguraesApi Class Doc Comment
 *
 * @category Class
 * @package  IdPluggerPromotion
 * @author   OpenAPI Generator team
...
class ConfiguraesApi
{
    ...
    /**
     * Operation promotionConfigWebhook
     *
     * Configura o webhook da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdPluggerPromotion\Model\PromotionConfigWebhookRequest|null $promotion_config_webhook_request promotion_config_webhook_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['promotionConfigWebhook'] to see the possible values for this operation
     *
     * @throws \IdPluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdPluggerPromotion\Model\PromotionConfigWebhook200Response|\IdPluggerPromotion\Model\PromotionConfigWebhook400Response|\IdPluggerPromotion\Model\PromotionConfigWebhook401Response
     */
    public function promotionConfigWebhook($promotion_id, $promotion_config_webhook_request = null, string $contentType = self::contentTypes['promotionConfigWebhook'][0])
    {
        list($response) = $this->promotionConfigWebhookWithHttpInfo($promotion_id, $promotion_config_webhook_request, $contentType);
        return $response;
    }

    /**
     * Operation promotionConfigWebhookWithHttpInfo
     *
     * Configura o webhook da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdPluggerPromotion\Model\PromotionConfigWebhookRequest|null $promotion_config_webhook_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['promotionConfigWebhook'] to see the possible values for this operation
     *
     * @throws \IdPluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdPluggerPromotion\Model\PromotionConfigWebhook200Response|\IdPluggerPromotion\Model\PromotionConfigWebhook400Response|\IdPluggerPromotion\Model\PromotionConfigWebhook401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function promotionConfigWebhookWithHttpInfo($promotion_id, $promotion_config_webhook_request = null, string $contentType = self::contentTypes['promotionConfigWebhook'][0])
    {
        $request = $this->promotionConfigWebhookRequest($promotion_id, $promotion_config_webhook_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdPluggerPromotion\Model\PromotionConfigWebhook200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdPluggerPromotion\Model\PromotionConfigWebhook400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdPluggerPromotion\Model\PromotionConfigWebhook401Response',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation promotionConfigWebhookAsync
     *
     * Configura o webhook da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     */
    public function promotionConfigWebhookAsync($promotion_id, $promotion_config_webhook_request = null, string $contentType = self::contentTypes['promotionConfigWebhook'][0])
    {
        return $this->promotionConfigWebhookAsyncWithHttpInfo($promotion_id, $promotion_config_webhook_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation promotionConfigWebhookAsyncWithHttpInfo
     *
     * Configura o webhook da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function promotionConfigWebhookAsyncWithHttpInfo($promotion_id, $promotion_config_webhook_request = null, string $contentType = self::contentTypes['promotionConfigWebhook'][0])
    {
        $returnType = '\IdPluggerPromotion\Model\PromotionConfigWebhook200Response';
        $request = $this->promotionConfigWebhookRequest($promotion_id, $promotion_config_webhook_request, $contentType);
    ...
    /**
     * Create request for operation 'promotionConfigWebhook'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdPluggerPromotion\Model\PromotionConfigWebhookRequest|null $promotion_config_webhook_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['promotionConfigWebhook'] to see the possible values for this operation
     ...
     */
    public function promotionConfigWebhookRequest($promotion_id, $promotion_config_webhook_request = null, string $contentType = self::contentTypes['promotionConfigWebhook'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling promotionConfigWebhook'
            );
        }
        ...
        // for model (json/xml)
        if (isset($promotion_config_webhook_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($promotion_config_webhook_request));
            } else {
                $httpBody = $promotion_config_webhook_request;
            }

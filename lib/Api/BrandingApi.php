...
class BrandingApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['brandingIndex'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotion\Model\BrandingIndex200Response|\IdpluggerPromotion\Model\BrandingIndex400Response|\IdpluggerPromotion\Model\BrandingIndex401Response
     */
    public function brandingIndex($promotion_id, $_fields = null, string $contentType = self::contentTypes['brandingIndex'][0])
    {
        list($response) = $this->brandingIndexWithHttpInfo($promotion_id, $_fields, $contentType);
        return $response;
    }

    /**
     * Operation brandingIndexWithHttpInfo
     *
     * Dados referentes a identidade visual da marca da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotion\Model\BrandingIndex200Response|\IdpluggerPromotion\Model\BrandingIndex400Response|\IdpluggerPromotion\Model\BrandingIndex401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function brandingIndexWithHttpInfo($promotion_id, $_fields = null, string $contentType = self::contentTypes['brandingIndex'][0])
    {
        $request = $this->brandingIndexRequest($promotion_id, $_fields, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\BrandingIndex200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\BrandingIndex400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\BrandingIndex401Response',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function brandingIndexAsync($promotion_id, $_fields = null, string $contentType = self::contentTypes['brandingIndex'][0])
    {
        return $this->brandingIndexAsyncWithHttpInfo($promotion_id, $_fields, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation brandingIndexAsyncWithHttpInfo
     *
     * Dados referentes a identidade visual da marca da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function brandingIndexAsyncWithHttpInfo($promotion_id, $_fields = null, string $contentType = self::contentTypes['brandingIndex'][0])
    {
        $returnType = '\IdpluggerPromotion\Model\BrandingIndex200Response';
        $request = $this->brandingIndexRequest($promotion_id, $_fields, $contentType);
    ...
    /**
     * Create request for operation 'brandingIndex'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string|null $_fields Campos a serem retornados pela API (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['brandingIndex'] to see the possible values for this operation
     ...
     */
    public function brandingIndexRequest($promotion_id, $_fields = null, string $contentType = self::contentTypes['brandingIndex'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling brandingIndex'
            );
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['brandingUpdate'] to see the possible values for this operation
     *
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdpluggerPromotion\Model\BrandingUpdate200Response|\IdpluggerPromotion\Model\BrandingUpdate400Response|\IdpluggerPromotion\Model\BrandingUpdate401Response
     */
    public function brandingUpdate($promotion_id, $branding = null, string $contentType = self::contentTypes['brandingUpdate'][0])
    {
        list($response) = $this->brandingUpdateWithHttpInfo($promotion_id, $branding, $contentType);
        return $response;
    }

    /**
     * Operation brandingUpdateWithHttpInfo
     *
     * Altera os dados referentes a identidade visual da marca da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdpluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdpluggerPromotion\Model\BrandingUpdate200Response|\IdpluggerPromotion\Model\BrandingUpdate400Response|\IdpluggerPromotion\Model\BrandingUpdate401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function brandingUpdateWithHttpInfo($promotion_id, $branding = null, string $contentType = self::contentTypes['brandingUpdate'][0])
    {
        $request = $this->brandingUpdateRequest($promotion_id, $branding, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\BrandingUpdate200Response',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\BrandingUpdate400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\IdpluggerPromotion\Model\BrandingUpdate401Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function brandingUpdateAsync($promotion_id, $branding = null, string $contentType = self::contentTypes['brandingUpdate'][0])
    {
        return $this->brandingUpdateAsyncWithHttpInfo($promotion_id, $branding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation brandingUpdateAsyncWithHttpInfo
     *
     * Altera os dados referentes a identidade visual da marca da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function brandingUpdateAsyncWithHttpInfo($promotion_id, $branding = null, string $contentType = self::contentTypes['brandingUpdate'][0])
    {
        $returnType = '\IdpluggerPromotion\Model\BrandingUpdate200Response';
        $request = $this->brandingUpdateRequest($promotion_id, $branding, $contentType);
    ...
    /**
     * Create request for operation 'brandingUpdate'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  \IdpluggerPromotion\Model\Branding|null $branding (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['brandingUpdate'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function brandingUpdateRequest($promotion_id, $branding = null, string $contentType = self::contentTypes['brandingUpdate'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling brandingUpdate'
            );
        }

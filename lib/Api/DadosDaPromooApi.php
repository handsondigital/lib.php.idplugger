...
/**
 * DadosDaPromooApi Class Doc Comment
 *
 * @category Class
 * @package  IdPluggerPromotion
 * @author   OpenAPI Generator team
...
class DadosDaPromooApi
{
    ...
    /**
     * Operation promotionConfigsIndex
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['promotionConfigsIndex'] to see the possible values for this operation
     *
     * @throws \IdPluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \IdPluggerPromotion\Model\PromotionConfigsIndex200Response|\IdPluggerPromotion\Model\PromotionConfigsIndex400Response|\IdPluggerPromotion\Model\PromotionConfigsIndex401Response
     */
    public function promotionConfigsIndex($promotion_id, string $contentType = self::contentTypes['promotionConfigsIndex'][0])
    {
        list($response) = $this->promotionConfigsIndexWithHttpInfo($promotion_id, $contentType);
        return $response;
    }

    /**
     * Operation promotionConfigsIndexWithHttpInfo
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @throws \IdPluggerPromotion\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \IdPluggerPromotion\Model\PromotionConfigsIndex200Response|\IdPluggerPromotion\Model\PromotionConfigsIndex400Response|\IdPluggerPromotion\Model\PromotionConfigsIndex401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function promotionConfigsIndexWithHttpInfo($promotion_id, string $contentType = self::contentTypes['promotionConfigsIndex'][0])
    {
        $request = $this->promotionConfigsIndexRequest($promotion_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\IdPluggerPromotion\Model\PromotionConfigsIndex200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation promotionConfigsIndexAsync
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     */
    public function promotionConfigsIndexAsync($promotion_id, string $contentType = self::contentTypes['promotionConfigsIndex'][0])
    {
        return $this->promotionConfigsIndexAsyncWithHttpInfo($promotion_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation promotionConfigsIndexAsyncWithHttpInfo
     *
     * Retorna dados da promoção
     *
     * @param  string $promotion_id ID da promoção (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function promotionConfigsIndexAsyncWithHttpInfo($promotion_id, string $contentType = self::contentTypes['promotionConfigsIndex'][0])
    {
        $returnType = '\IdPluggerPromotion\Model\PromotionConfigsIndex200Response';
        $request = $this->promotionConfigsIndexRequest($promotion_id, $contentType);
    ...
    /**
     * Create request for operation 'promotionConfigsIndex'
     *
     * @param  string $promotion_id ID da promoção (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['promotionConfigsIndex'] to see the possible values for this operation
     *
     ...
     */
    public function promotionConfigsIndexRequest($promotion_id, string $contentType = self::contentTypes['promotionConfigsIndex'][0])
    {

        // verify the required parameter 'promotion_id' is set
        if ($promotion_id === null || (is_array($promotion_id) && count($promotion_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $promotion_id when calling promotionConfigsIndex'
            );
        }


        $resourcePath = '/v3/promotion/{promotion_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

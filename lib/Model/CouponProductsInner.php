...
/**
 * CouponProductsInner Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class CouponProductsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Coupon_products_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Obrigatório se não enviado o serial_number
     *
     * @return self
     */
     ...
     * Sets serial_number
     *
     * @param string|null $serial_number Obrigatório se não enviado o id
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity Quantidade deste produto no cupom (envio obrigatório)
     *
     * @return self
     */
     ...
     * Sets cost
     *
     * @param float|null $cost Valor do produto no cupom (envio obrigatório)
     *
     * @return self
     */

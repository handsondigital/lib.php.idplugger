...
/**
 * AddLuckyNumberCustom Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class AddLuckyNumberCustom implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddLuckyNumberCustom';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lucky_numbers'] === null) {
            $invalidProperties[] = "'lucky_numbers' can't be null";
        }
     ...
     * Sets lucky_numbers
     *
     * @param int[] $lucky_numbers lucky_numbers
     *
     * @return self
     */

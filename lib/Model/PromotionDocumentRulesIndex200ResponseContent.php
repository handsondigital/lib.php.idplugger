<?php
/**
 * PromotionDocumentRulesIndex200ResponseContent
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PromotionDocumentRulesIndex200ResponseContent Class Doc Comment
 *
 * @category Class
 * @package  IdPluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionDocumentRulesIndex200ResponseContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'promotion_document_rules_index_200_response_content';
    ...
    protected static $openAPITypes = [
        'terms' => 'string',
        'privacy' => 'string',
        'regulations' => '\IdPluggerPromotion\Model\PromotionDocumentRulesIndex200ResponseContentRegulationsInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('regulations', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets regulations
     *
     * @return \IdPluggerPromotion\Model\PromotionDocumentRulesIndex200ResponseContentRegulationsInner[]|null
     */
    public function getRegulations()
    {
        return $this->container['regulations'];
    }

    /**
     * Sets regulations
     *
     * @param \IdPluggerPromotion\Model\PromotionDocumentRulesIndex200ResponseContentRegulationsInner[]|null $regulations regulations
     *
     * @return self
     */
    public function setRegulations($regulations)
    {
        if (is_null($regulations)) {
            throw new \InvalidArgumentException('non-nullable regulations cannot be null');
        }
        $this->container['regulations'] = $regulations;

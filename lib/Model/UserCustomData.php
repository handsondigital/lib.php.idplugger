...
/**
 * UserCustomData Class Doc Comment
 *
 * @category Class
 * @package  IdpluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class UserCustomData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_custom_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('another', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['another'];
    }

    /**
     * Sets another
     *
     * @param string|null $another another
     *
     * @return self
     */
    ...
    {
        if (is_null($another)) {
            throw new \InvalidArgumentException('non-nullable another cannot be null');
        }
        $this->container['another'] = $another;

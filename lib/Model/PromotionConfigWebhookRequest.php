...
/**
 * PromotionConfigWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  IdPluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionConfigWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'promotion_config_webhook_request';
    ...
    */
     ...
     * Sets secret
     *
     * @param string|null $secret O parâmetro secret será enviado para o seu webhook via **authorization: `secret`**. Por tanto, seu app deve validar se o secret é válido.
     *
     * @return self
     */

...
class Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'lucky_numbers_offer' => 'int',
        'lucky_numbers_multiplier' => 'float',
        'status' => 'bool',
        'imagem' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'serial_number' => null,
        'name' => null,
        'lucky_numbers_offer' => null,
        'lucky_numbers_multiplier' => null,
        'status' => null,
        'imagem' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'serial_number' => false,
        'name' => false,
        'lucky_numbers_offer' => false,
        'lucky_numbers_multiplier' => false,
        'status' => false,
        'imagem' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'name' => 'name',
        'lucky_numbers_offer' => 'lucky_numbers_offer',
        'lucky_numbers_multiplier' => 'lucky_numbers_multiplier',
        'status' => 'status',
        'imagem' => 'imagem'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'lucky_numbers_offer' => 'setLuckyNumbersOffer',
        'lucky_numbers_multiplier' => 'setLuckyNumbersMultiplier',
        'status' => 'setStatus',
        'imagem' => 'setImagem'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'lucky_numbers_offer' => 'getLuckyNumbersOffer',
        'lucky_numbers_multiplier' => 'getLuckyNumbersMultiplier',
        'status' => 'getStatus',
        'imagem' => 'getImagem'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('lucky_numbers_offer', $data ?? [], null);
        $this->setIfExists('lucky_numbers_multiplier', $data ?? [], null);
    ...
    */
     ...
     * Sets serial_number
     *
     * @param string|null $serial_number Número serial do produto
     *
     * @return self
     */
    ...
    /**
     * Gets lucky_numbers_offer
     *
     * @return int|null
     */
    public function getLuckyNumbersOffer()
    {
        return $this->container['lucky_numbers_offer'];
    }

    /**
     * Sets lucky_numbers_offer
     *
     * @param int|null $lucky_numbers_offer Quantidade de números da sorte oferecidos pelo produto
     *
     * @return self
     */
    public function setLuckyNumbersOffer($lucky_numbers_offer)
    {
        if (is_null($lucky_numbers_offer)) {
            throw new \InvalidArgumentException('non-nullable lucky_numbers_offer cannot be null');
        }
        $this->container['lucky_numbers_offer'] = $lucky_numbers_offer;

        return $this;
    }

    /**
     * Gets lucky_numbers_multiplier
     *
     * @return float|null
     */
    public function getLuckyNumbersMultiplier()
    {
        return $this->container['lucky_numbers_multiplier'];
    }

    /**
     * Sets lucky_numbers_multiplier
     *
     * @param float|null $lucky_numbers_multiplier Quantidade de vezes que o produto multiplica o total de números da sorte do cupom
     *
     * @return self
     */
    public function setLuckyNumbersMultiplier($lucky_numbers_multiplier)
    {
        if (is_null($lucky_numbers_multiplier)) {
            throw new \InvalidArgumentException('non-nullable lucky_numbers_multiplier cannot be null');
        }
        $this->container['lucky_numbers_multiplier'] = $lucky_numbers_multiplier;
     ...
     * Sets status
     *
     * @param bool|null $status Produto ativo ou inativo
     *
     * @return self
     */
     ...
     * Sets imagem
     *
     * @param string|null $imagem URL da imagem do produto
     *
     * @return self
     */

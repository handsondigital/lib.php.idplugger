<?php
/**
 * PromotionLuckyNumbersRemoveRequestLuckyNumbersInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PromotionLuckyNumbersRemoveRequestLuckyNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  IdPluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionLuckyNumbersRemoveRequestLuckyNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'promotion_lucky_numbers_remove_request_lucky_numbers_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID do Número da Sorte
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param int|null $user_id ID do Usuário dono do Número da Sorte
     *
     * @return self
     */

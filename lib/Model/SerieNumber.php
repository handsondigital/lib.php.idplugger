 ...
 */
class SerieNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SerieNumber';
    ...
    {
        $this->setIfExists('serie_number', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($serie_number)) {
            throw new \InvalidArgumentException('non-nullable serie_number cannot be null');
        }

...
/**
 * PromotionDatetimeShowAwardeds Class Doc Comment
 *
 * @category Class
 * @package  IdPluggerPromotion
 * @author   OpenAPI Generator team
 ...
 */
class PromotionDatetimeShowAwardeds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotion_datetime_show_awardeds';
    ...
    */
     ...
     * Sets start
     *
     * @param string|null $start Data e hora em que a promoção começará a mostrar os ganhadores
     *
     * @return self
     */

 ...
 */
class PromotionDatetime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotion_datetime';
    ...
    protected static $setters = [
        'active' => 'setActive',
        'participate' => 'setParticipate',
        'show_awardeds' => 'setShowAwardeds',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('participate', $data ?? [], null);
        $this->setIfExists('show_awardeds', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['participate'];
    }
    ...
    public function setParticipate($participate)
    {
        if (is_null($participate)) {
            throw new \InvalidArgumentException('non-nullable participate cannot be null');
        }
        $this->container['participate'] = $participate;
    ...
    {
        return $this->container['show_awardeds'];
    }
     ...
     * @return self
     */
    public function setShowAwardeds($show_awardeds)
    {
        if (is_null($show_awardeds)) {
            throw new \InvalidArgumentException('non-nullable show_awardeds cannot be null');
        }
        $this->container['show_awardeds'] = $show_awardeds;
     ...
     * Sets shutdown
     *
     * @param string|null $shutdown Data e hora em que a API deixará de responder as informações referentes à promoção
     *
     * @return self
     */

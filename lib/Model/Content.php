...
class Content implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_PATH_URL = 'path_url';
    ...
    {
        $this->setIfExists('key', $data ?? [], '{uuid}');
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key Chave que identifica o conteúdo (em caso de conteúdo sem grupo, a chave pode ser uma tag)
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Conteúdo (o formato depende do uso, é recomendado json)
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int|null $order Ordem de apresentação, começando em 1
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Tipo do dado armazenado
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string|null $group Grupo ao qual o conteúdo faz parte
     *
     * @return self
     */
